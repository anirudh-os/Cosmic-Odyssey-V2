  ...
  return (
    <div>
          ...
          <div className="logo-container">
            <a href="/" className="link-body-emphasis text-decoration-none">
              <img
                ...
                alt="logo"
              />
              <span className="fs-4 my-15">Cosmic Odyssey</span>
            </a>
          </div>
          <ul className="nav">
      ...
      {showMore && (
        <div
          id="cards6"
          className={`animated-cards ${showMore ? "visible" : ""}`}
        >
          <Link to="/alphaCentauri" className="card" id="card4">
            <img src={Alpha_Centauri} alt="Alpha Centauri" />
            ALPHA CENTAURI
            <p>
              Alpha Centauri, triple star system, the faintest component of
              which, Proxima Centauri, is the closest star to the Sun, about 4.2
              light-years distant.
            </p>
          </Link>
          <Link to="/sirius" className="card" id="card5">
            ...
            SIRIUS
            <p>
              Sirius, brightest star in the night sky. It is a binary star in
          ...
          <Link to="/andromedagalaxy" className="card" id="card6">
            ...
            ANDROMEDA GALAXY
            <p>
              Andromeda Galaxy, great spiral galaxy in the constellation
              Andromeda, the nearest large galaxy.
            </p>
          </Link>
        </div>
      )}
      ...
      {showMore && (
        ...
        >
          <Link to="/triangulumgalaxy" className="card" id="card7">
            ...
            TRIANGULUM GALAXY
            <p>
              Triangulum Galaxy, is the third-largest member of the Local Group
              of galaxies, after the Andromeda galaxy
            </p>
          </Link>
          <Link to="/whirlpoolgalaxy" className="card" id="card8">
            ...
            WHIRLPOOL GALAXY
            <p>
              The Whirlpool Galaxy is actively forming new stars, with its
              spiral arms rich in hydrogen gas, which fuels star formation
            </p>
          </Link>
          <Link to="/crabNebula" className="card" id="card9">
            ...
            CRAB NEBULA
            <p>
              The Carina Nebula is a vast star-forming region located about
      ...
      {showMore && (
        ...
        >
          <Link to="/magellanicCloud" className="card" id="card10">
            ...
            MAGELLANIC CLOUD
            <p>
              Nearly 200,000 light-years from Earth, the Large Magellanic Cloud,
              a satellite galaxy of the Milky Way, floats in space, in a long
              and slow dance around our galaxy. Vast clouds of gas within it
              slowly collapse to form new stars.
            </p>
          </Link>
          <Link to="/polaris" className="card" id="card11">
            ...
            POLARIS
            <p>
              Polaris, Earth’s present northern polestar, or North Star, at the
              end of the “handle” of the so-called Little Dipper in the
              constellation Ursa Minor.Polaris is actually a triple star system.
            </p>
          </Link>
          <Link to="/betelgeuse" className="card" id="card12">
            ...
            <p>
              ...
              marking the eastern shoulder of the hunter.Betelgeuse is a red
              supergiant star roughly 764 times as large as the Sun. For
              comparison, the diameter of Mars’s orbit around the Sun is 328
